...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("poly_sdk_zig", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "poly_sdk_zig" is the name you will use in your source code to
                // import this module (e.g. `@import("poly_sdk_zig")`). The name is
    ...
    const examples = [_]struct {
        ...
        .{
            .name = "smart_auto_trade",
            .source = "examples/smart_auto_trade.zig",
            .description = "BTC 15m probability bias auto trading system",
        },
        .{
